...
export default function Popup({ children, title, width, isOpen, setPopup, canClose }: Readonly<Props>) {

  const shadowClasses = clsx(
    "fixed inset-0 z-1001 bg-[rgba(0,0,0,.5)] items-center justify-center px-5 animate-[fade-in_.3s]",
    isOpen ? "flex" : "hidden"
  )
